        ...
        http
                ...
                .authorizeHttpRequests(
                        req -> req
                                ...
                                .requestMatchers(HttpMethod.GET, Constants.API.USER.ROOT + Constants.API.USER.USERS_ALL_ADMIN).hasAuthority("admin")
                                .requestMatchers(HttpMethod.PUT, Constants.API.USER.ROOT + Constants.API.USER.USER_UPDATE).hasAuthority("user")
                                .requestMatchers(HttpMethod.POST, Constants.API.USER.ROOT + Constants.API.USER.USER_ROLE).hasAuthority("admin")
                                .requestMatchers(HttpMethod.DELETE, Constants.API.USER.ROOT + Constants.API.USER.USER_BY_ID).hasAuthority("admin")
                                .requestMatchers(HttpMethod.GET, Constants.API.USER.ROOT + Constants.API.TRANSPORT.TRANSPORTS_ALL_ADMIN).hasAuthority("admin")
